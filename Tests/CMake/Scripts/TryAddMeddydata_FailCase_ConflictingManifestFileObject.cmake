...
set(MY_TEST_NAME "TryAddMeddydata_FailCase_ConflictingManifestFileObject")
...
# Create a conflicting file object with where it's going to try creating the manifest file.
file(MAKE_DIRECTORY "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/.meddyproject/meddydata")
file(MAKE_DIRECTORY "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/.meddyproject/meddydata/MyOtherCoolTextFiles")
file(MAKE_DIRECTORY "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/.meddyproject/meddydata/MyOtherCoolTextFiles/Hey.txt")
file(MAKE_DIRECTORY "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/.meddyproject/meddydata/MyOtherCoolTextFiles/Hey.txt/metadata.json")
