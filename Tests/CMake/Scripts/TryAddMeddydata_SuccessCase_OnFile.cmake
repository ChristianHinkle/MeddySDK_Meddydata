...
if(NOT EXISTS "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/_meddyproject/ftree/MyOtherCoolTextFiles/Hey.txt/_meddydata")
  message("Failed. Meddydata directory does not exist.")
  cmake_language(EXIT 4)
endif()

if(NOT EXISTS "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/_meddyproject/ftree/MyOtherCoolTextFiles/Hey.txt/_meddydata/metadata.json")
