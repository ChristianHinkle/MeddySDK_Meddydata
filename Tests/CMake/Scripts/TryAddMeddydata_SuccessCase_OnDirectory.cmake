...
set(MY_TEST_NAME "TryAddMeddydata_SuccessCase_OnDirectory")
...
if(NOT EXISTS "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/_meddyproject/ftree/MyOtherCoolTextFiles/_meddydata")
  message("Failed. Meddydata directory does not exist.")
  cmake_language(EXIT 4)
endif()

if(NOT EXISTS "${MY_TEST_WORKING_DIRECTORY}/MyTestGeneratedFiles/${MY_TEST_NAME}/MyProjectDir/_meddyproject/ftree/MyOtherCoolTextFiles/_meddydata/metadata.json")
